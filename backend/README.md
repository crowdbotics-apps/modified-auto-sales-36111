...
## Project Structure
    ...
    ├── modified_auto_sales_36111  # Django project configurations
...
1. Clone this repo and `cd modified_auto_sales_36111`
...
2. Clone this repo and `cd modified_auto_sales_36111`
